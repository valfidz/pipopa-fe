  ...
  return (
    <div className="bg-white">
      <div className="relative isolate px-4 pt-10 sm:px-6 lg:px-8">
        ...
        {/* Main Content */}
        <div className="mx-auto max-w-xl sm:max-w-2xl lg:max-w-4xl py-20 sm:py-32 lg:py-40">
          ...
          <div className="text-center">
            <h1 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl lg:text-6xl">
              Kalo bisa pinjam kenapa harus beli
            </h1>
            <p className="mt-6 text-base sm:text-lg lg:text-xl leading-8 text-gray-600">
